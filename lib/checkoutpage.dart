...
import 'package:foodgood/payment.dart';
...
class CheckOutPage extends StatefulWidget {
  ...
  const CheckOutPage({Key key, this.email, this.total}) : super(key: key);
                      ...
                      child: Column(
                        children: [
                          ...
                          Container(
                            ...
                            width: 300,
                            child: Text(
                                "Pickup time daily from 10.00 A.M to 10.00 P.M from our restaurant. Please allow 15-30 minutes to prepare your order before pickup time"),
                          ),
                          Row(
                            children: [
