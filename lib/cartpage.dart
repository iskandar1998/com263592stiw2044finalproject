...
class CartPage extends StatefulWidget {
  ...
  const CartPage({Key key, this.email}) : super(key: key);
...
class _CartPageState extends State<CartPage> {
  ...
  _loadMyCart() {
    http.post(Uri.parse(CONFIG.SERVER + "/foodgood/mobile/loadusercart.php"),
  ...
  Future<void> _modQty(int index, String s) async {
    ...
    http.post(Uri.parse(CONFIG.SERVER + "/foodgood/mobile/updatecart.php"),
        body: {
          "email": widget.email,
          "op": s,
  ...
  Future<void> _deleteCart(int index) async {
    ...
    progressDialog.show();
    await Future.delayed(Duration(seconds: 1));
    http.post(Uri.parse(CONFIG.SERVER + "/foodgood/mobile/deletecart.php"),
        body: {
          "email": widget.email,
          "prid": _cartList[index]['productId']
        }).then((response) {
